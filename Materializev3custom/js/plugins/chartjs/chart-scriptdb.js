...
//var dataBarChart = {
//    labels: ["T1", "T2", "T3", "T4", "T5", "T1", "T1", "T2", "T3", "T4", "T5", "T1", "T1", "T2", "T3", "T4", "T5", "T1", "T1", "T2"],
//    datasets: [{
//        label: "Bar dataset",
//        fillColor: "#46BFBD",
//        strokeColor: "#46BFBD",
...
//        data: [6, 9, 8, 4, 6, 6, 6, 9, 8, 4, 6, 6, 6, 9, 8, 4, 6, 6, 4, 6]
//    }]
//};
...
*/
//var radarChartData = {
//    labels: ["Nam Hội An", "Landmark 81", "Diamond", "Masteri", "Vista Verde", "Nam Hội An"],
//    datasets: [{
//        label: "First dataset",
...
*/
var lineChartData = {
    labels: ["TechOne", "FDC T1", "AA Corp", "Hà Linh", "TCons", "Ban An Ninh", "TechOne", "FDC T1", "AA Corp", "Hà Linh"],
    datasets: [{
        label: "My dataset",
        ...
        data: [65, 45, 50, 30, 63, 45, 65, 45, 50, 30]
    }]
...
window.onload = function() {
    ...
    //window.trendingLineChart = new Chart(trendingLineChart).Line(trendingdata, {
